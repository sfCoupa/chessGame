ChessGame.queen = (function (chessgame, undefined) {

    var _this = this;
    var validLocations = [];

    chessgame.moveQueen = function (newTile) {
        validMoves(newTile);
    }
    ...
    function validMoves(newTile) {
        ...
        if (toX == fromX) { ChessGame.movePiece(newTile); return; }
        if (toY == fromY) { ChessGame.movePiece(newTile); return; }
